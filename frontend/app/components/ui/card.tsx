...
function Card({
  ...
  return (
    <div
      ...
      data-size={size}
      className={cn(
        // A bordered sheet, not a floating card: hairline border instead of
        // the default ring/shadow, square corners instead of rounded-xl —
        // this is the panel idiom the whole system is built on.
